...
int main() {
    int i;
    printf("Amna Asim Khan\n");
	printf("23k-0859\n");
    srand(time(NULL));

    char Name_pool[20][20] = {"Anum", "Ayesha", "Bisma", "Bushra",
                              "Dania", "Esha", "Farha", "Gulmeena",
                              "Hiba", "Izza", "Javeria", "Kehkashan",
                              "Laiba", "Momina", "Naima", "Rumaisa",
                              "Sabeena", "Tanisha", "warisha", "Barirah"};
    int Name_Used[20];
    for (i = 0; i < 20; i++) {
        Name_Used[i] = 0;
    }
