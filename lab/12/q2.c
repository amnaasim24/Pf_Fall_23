...
// Lab 12
// Question 2
// Description:Make 2 separate blank word files with text, "This is a test.".Open them in a C program as a binary file and
//             compare the contents. Are the 2 files equal?
