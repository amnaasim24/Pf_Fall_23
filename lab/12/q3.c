...
//             Make a console application that allows to input course infromation and save data to a file. Then it has an option
//             to view transcript, calculate CGPA and SGPAs.
